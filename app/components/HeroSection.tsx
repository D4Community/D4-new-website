    ...
    return (
        <div>
            <div className="md:py-40 py-28 flex justify-center items-center gap-20">
                <div>
                <h1 className="sm:text-[55px] text-[48px] font-semibold sm:leading-[60px] leading-[50px] bg-[linear-gradient(to_left,#E49976,#A46FF2)] text-transparent bg-clip-text [-webkit-background-clip:text]">{title}</h1>
                    <div className="flex flex-col gap-5 pt-5 max-w-[1780px] font-light">
                        <p>{description}</p>
                        <p>{description2}</p>
                        <p>{description3}</p>
                    </div>
                ...
                <div>
                    <Image className="max-w-[]" src={img} alt="About" />
                </div>
            </div>
        </div>
    )
